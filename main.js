...
var snake = {
  ...
  y: 160,
  dx: grid,
  //hướng di chuyển theo phương x hoặc y,ở đây khi start game
...
function loop() {
  ...
  if (++count < 4) {
    return; //slow game 15 fps 60 - 60/15
  }
  count = 0;
  ...
  if (snake.cells.length > snake.startCells) {
    snake.cells.pop();
  }
  // draw ringo
  ...
  snake.cells.map(function(cell, index) {
